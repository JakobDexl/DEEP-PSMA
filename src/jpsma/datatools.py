...
def prepare_case(
    fdg_ct, fdg_pet, fdg_totseg,
    psma_ct, psma_pet, psma_totseg,
    ...
    for key in moving:
        ...
        aligned_moving[key] = sitk.Resample(
            moving[key], fixed['CT'], transform, interp, 0.0, moving[key].GetPixelID()
        )
