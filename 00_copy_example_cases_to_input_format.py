...
top='/mnt/data4/Datasets/DeepPSMA25/DEEP-PSMA_CHALLENGE_DATA/CHALLENGE_DATA/' #update to location of training data folder top directory as distributed. Subdirectories per case of the form 'train_XXXX'
case='train_0025' #large filesize case
case='train_0003'
##case='train_0083' #large filesize case
##case='train_0060' #"Average" case

out_top='test/input/interf1'
